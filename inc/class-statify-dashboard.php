...
class Statify_Dashboard extends Statify {
	...
	public static function add_js() {
		...
		wp_localize_script(
			...
			array(
				'i18n'  => array(
					'error'        => strip_tags( esc_html__( 'Error loading data.', 'statify' ) ),
					'nodata'       => strip_tags( esc_html__( 'No data available.', 'statify' ) ),
					'pageview'     => strip_tags( esc_html__( 'Pageview', 'statify' ) ),
					'pageviews'    => strip_tags( esc_html__( 'Pageviews', 'statify' ) ),
					'since'        => strip_tags( esc_html__( 'since', 'statify' ) ),
					'today'        => strip_tags( esc_html__( 'today', 'statify' ) ),
				),
			)
		);
	}
